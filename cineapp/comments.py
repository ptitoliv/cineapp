...
def update_mark_comment():
    ...
    if mark_comment is not None:
        ...
        if request.endpoint == "comments.delete_mark_comment":
        ...
        elif request.endpoint == "comments.edit_mark_comment":
        ...
        try:
            ...
            # Try to send the email
            mark_comment_notification(mark_comment,request.endpoint.split('.')[1])
